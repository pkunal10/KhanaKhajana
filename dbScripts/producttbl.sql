...
GO
PRINT N'Rename refactoring operation with key  is skipped, element [dbo].[Table].[Id] (SqlSimpleColumn) will not be renamed to ProductId';
...
BEGIN TRANSACTION
GO
PRINT N'Creating [dbo].[Prpducts]...';


GO
CREATE TABLE [dbo].[Prpducts] (
