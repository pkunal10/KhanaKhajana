...
BEGIN TRANSACTION
GO
PRINT N'Rename [dbo].[Orders].[Status] to MobileNo';


GO
EXECUTE sp_rename @objname = N'[dbo].[Orders].[Status]', @newname = N'MobileNo', @objtype = N'COLUMN';
...
GO
ALTER TABLE [dbo].[Orders] ALTER COLUMN [MobileNo] VARCHAR (10) NOT NULL;


GO
ALTER TABLE [dbo].[Orders]
    ADD [Instruction] VARCHAR (1000) NULL,
        [Status]      INT            NOT NULL;
